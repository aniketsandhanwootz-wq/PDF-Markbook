...
def _sa_client_from_json_or_path(google_sa_json: str) -> gspread.Client:
    ...
    Returns an authorized gspread Client in a gspread-version-agnostic way.
    """
...
class SheetsAdapter(StorageAdapter):
    """
    Google Sheets implementation of StorageAdapter.
    - Auto-creates tabs with headers.
    - Uses simple batch updates.
    """
